!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(["exports"], e)
    : e(
        ((t = "undefined" != typeof globalThis ? globalThis : t || self).acorn =
          {})
      );
})(this, function (t) {
  "use strict";
    ...
    return t < 65
      ...
      : t < 91 ||
          (t < 97
            ...
            : t < 123 ||
              (t <= 65535
                ? 170 <= t && U.test(String.fromCharCode(t))
                : !1 !== e && s(t, O)));
  }
  function o(t, e) {
    return t < 48
          ...
          (!(t < 65) &&
            (t < 91 ||
              (t < 97
                ...
                : t < 123 ||
                  (t <= 65535
                    ? 170 <= t && G.test(String.fromCharCode(t))
                    : !1 !== e && (s(t, O) || s(t, M))))));
  }
  function r(t, e) {
    void 0 === e && (e = {}),
  ...
  var i = { beforeExpr: !0 },
    ...
    p = {};
  function c(t, e) {
    return ((e = void 0 === e ? {} : e).keyword = t), (p[t] = new r(t, e));
  }
  var x = {
      num: new r("num", e),
      ...
      _default: c("default", i),
      _do: c("do", { isLoop: !0, beforeExpr: !0 }),
      _else: c("else", i),
      _finally: c("finally"),
      _for: c("for", { isLoop: !0 }),
      _function: c("function", e),
      _if: c("if"),
      _return: c("return", i),
      _switch: c("switch"),
      _throw: c("throw", i),
  ...
  function H(t, e, i) {
    ...
    for (var s = e; s < i; s++) {
      ...
      if (u(a))
        return s < i - 1 && 13 === a && 10 === t.charCodeAt(s + 1)
          ? s + 2
          : s + 1;
    }
    return -1;
  ...
  function g(t) {
    return K[t] || (K[t] = new RegExp("^(?:" + t.replace(/ /g, "|") + ")$"));
  }
  function y(t) {
    return t <= 65535
  ...
  function X(t) {
    ...
    return (
      ...
      (t && null != t.allowHashBang) || (s.allowHashBang = 14 <= s.ecmaVersion),
      W(s.onToken) &&
        ((i = s.onToken),
      ...
      W(s.onComment) &&
        (s.onComment =
          ...
          function (t, e, i, s, a, r) {
            t = { type: t ? "Block" : "Line", value: e, start: i, end: s };
            n.locations && (t.loc = new _(this, a, r)),
              n.ranges && (t.range = [i, s]),
              o.push(t);
          })),
      s
    );
  ...
  function C(t, e, i) {
    (this.options = t = X(t)),
      ...
      (this.keywords = g(
        B[6 <= t.ecmaVersion ? 6 : "module" === t.sourceType ? "5module" : 5]
      ));
    var s = "",
      s =
        (!0 !== t.allowReserved &&
        ...
        (this.reservedWords = g(s)),
        (s ? s + " " : "") + a.strict);
    (this.reservedWordsStrict = g(s)),
      (this.reservedWordsStrictBind = g(s + " " + a.strictBind)),
      (this.input = String(e)),
      (this.containsEsc = !1),
      i
        ? ((this.pos = i),
  ...
  var e = {
    ...
    e =
      ...
      (e.canAwait.get = function () {
        for (var t = this.scopeStack.length - 1; 0 <= t; t--) {
          var e = this.scopeStack[t];
          if (e.inClassFieldInit || e.flags & Y) return !1;
          if (2 & e.flags) return 0 < (4 & e.flags);
        }
        return (
      ...
      (e.allowSuper.get = function () {
        ...
        return 0 < (64 & e) || t || this.options.allowSuperOutsideMethod;
      }),
      ...
      (e.inClassStaticBlock.get = function () {
        return 0 < (this.currentVarScope().flags & Y);
      }),
      (C.extend = function () {
      ...
      (C.parseExpressionAt = function (t, e, i) {
        i = new this(i, t, e);
        return i.nextToken(), i.parseExpression();
      }),
      (C.tokenizer = function (t, e) {
        return new this(e, t);
      }),
    ...
    e =
      ((e.strictDirective = function (t) {
        ...
        for (;;) {
          ...
          var e,
            i,
            s,
            a = J.exec(this.input.slice(t));
          if (!a) return !1;
          if ("use strict" === (a[1] || a[2]))
            return (
              (f.lastIndex = t + a[0].length),
      ...
      (e.afterTrailingComma = function (t, e) {
        if (this.type === t)
          return (
      ...
      (e.checkPatternErrors = function (t, e) {
        t &&
          (-1 < t.trailingComma &&
      ...
      (e.checkExpressionErrors = function (t, e) {
        return (
          !!t &&
          ((i = t.shorthandAssign),
          (t = t.doubleProto),
          e
            ? (0 <= i &&
              ...
              void (
                0 <= t &&
                this.raiseRecoverable(t, "Redefinition of __proto__ property")
              ))
            : 0 <= i || 0 <= t)
        );
        var i;
      ...
      (e.isSimpleAssignTarget = function (t) {
    ...
    et =
      ((e.isLet = function (t) {
        ...
        if (n(i, !0)) {
          for (var s = e + 1; o((i = this.input.charCodeAt(s)), !0); ) ++s;
          if (92 === i || (55295 < i && i < 56320)) return !0;
          t = this.input.slice(e, s);
      ...
      (e.parseStatement = function (t, e, i) {
        var s,
          a = this.type,
          r = this.startNode();
        switch ((this.isLet(t) && ((a = x._var), (s = "let")), a)) {
          case x._break:
          case x._continue:
          ...
          case x._export:
          case x._import:
            if (10 < this.options.ecmaVersion && a === x._import) {
              f.lastIndex = this.pos;
              var n = f.exec(this.input),
                n = this.pos + n[0].length,
                n = this.input.charCodeAt(n);
              if (40 === n || 46 === n)
            ...
            return (
              ...
              a === x._import ? this.parseImport(r) : this.parseExport(r, i)
            );
          default:
            ...
            return a === x.name && "Identifier" === o.type && this.eat(x.colon)
              ? this.parseLabeledStatement(r, n, o, t)
      ...
      (e.parseDoStatement = function (t) {
        return (
          ...
          6 <= this.options.ecmaVersion ? this.eat(x.semi) : this.semicolon(),
      ...
      (e.parseForStatement = function (t) {
        ...
        var i = this.isContextual("let"),
          s = !1,
          a = new S(),
          r = this.parseExpression(!(-1 < e) || "await", a);
        return this.type === x._in ||
          (s = 6 <= this.options.ecmaVersion && this.isContextual("of"))
          ? (9 <= this.options.ecmaVersion &&
              (this.type === x._in
                ? -1 < e && this.unexpected(e)
                : (t.await = -1 < e)),
      ...
      (e.parseFunctionStatement = function (t, e, i) {
        return this.next(), this.parseFunction(t, w | (i ? 0 : it), !1, e);
      }),
      ...
      (e.parseSwitchStatement = function (t) {
        ...
        this.next(),
          ...
          this.labels.push(tt),
          this.enterScope(0);
        for (var i, s = !1; this.type !== x.braceR; )
          this.type === x._case || this.type === x._default
            ? ((i = this.type === x._case),
    ...
    w =
      ...
      (e.parseTryStatement = function (t) {
        ...
        return (
          ...
          (t.finalizer = this.eat(x._finally) ? this.parseBlock() : null),
          t.handler ||
            t.finalizer ||
      ...
      (e.parseVar = function (t, e, i, s) {
        for (t.declarations = [], t.kind = i; ; ) {
          ...
          if (
            (this.parseVarId(a, i),
            this.eat(x.eq)
              ? (a.init = this.parseMaybeAssign(e))
              : s ||
                "const" !== i ||
                this.type === x._in ||
                (6 <= this.options.ecmaVersion && this.isContextual("of"))
              ? s ||
                ...
                (e && (this.type === x._in || this.isContextual("of")))
                ? (a.init = null)
                : this.raise(
                    this.lastTokEnd,
              ...
              : this.unexpected(),
            t.declarations.push(this.finishNode(a, "VariableDeclarator")),
            !this.eat(x.comma))
          )
            break;
        }
  ...
  (e.parseFunction = function (t, e, i, s, a) {
    this.initFunction(t),
      (9 <= this.options.ecmaVersion ||
        ...
        (this.type === x.star && e & it && this.unexpected(),
        (t.generator = this.eat(x.star))),
      8 <= this.options.ecmaVersion && (t.async = !!s),
      e & w &&
        ((t.id = 4 & e && this.type !== x.name ? null : this.parseIdent()),
        !t.id ||
          e & it ||
    ...
    return (
      ...
      e & w || (t.id = this.type === x.name ? this.parseIdent() : null),
      this.parseFunctionParams(t),
      this.parseFunctionBody(t, i, !1, a),
      (this.yieldPos = s),
      (this.awaitPos = r),
    ...
    (e.parseClass = function (t, e) {
      ...
      var i = this.strict,
        ...
        a = this.startNode(),
        r = !1;
      for (a.body = [], this.expect(x.braceL); this.type !== x.braceR; ) {
    ...
    (e.parseClassElement = function (t) {
      ...
      if (this.eatContextual("static")) {
        if (13 <= e && this.eat(x.braceL))
          return this.parseClassStaticBlock(i), i;
        this.isClassElementNameStart() || this.type === x.star
          ? (o = !0)
          : (s = "static");
      }
      return (
        ...
        e < 13 || this.type === x.parenL || "method" !== n || a || r
          ? ((s = (o = !i.static && E(i, "constructor")) && t),
            o &&
              "method" !== n &&
              this.raise(
                i.key.start,
            ...
            (i.kind = o ? "constructor" : n),
            this.parseClassMethod(i, a, r, s))
    ...
    (e.parseClassSuper = function (t) {
      t.superClass = this.eat(x._extends)
    ...
    (e.exitClassBody = function () {
      ...
      if (this.options.checkPrivateFields)
        for (
          var t = this.privateNameStack.length,
    ...
    (e.parseExportDefaultDeclaration = function () {
      var t, e;
      return this.type === x._function || (e = this.isAsyncFunction())
        ? ((t = this.startNode()),
          this.next(),
          e && this.next(),
          this.parseFunction(t, 4 | w, !1, e))
        : this.type === x._class
        ? ((t = this.startNode()), this.parseClass(t, "nullableID"))
        : ((e = this.parseMaybeAssign()), this.semicolon(), e);
    }),
    (e.checkExport = function (t, e, i) {
      t &&
        ("string" != typeof e &&
          (e = "Identifier" === e.type ? e.name : e.value),
        m(t, e) && this.raiseRecoverable(i, "Duplicate export '" + e + "'"),
        (t[e] = !0));
    }),
    ...
    (e.parseExportSpecifiers = function (t) {
      ...
      for (this.expect(x.braceL); !this.eat(x.braceR); ) {
        if (i) i = !1;
        else if ((this.expect(x.comma), this.afterTrailingComma(x.braceR)))
          break;
    ...
    (e.parseImportSpecifiers = function () {
      ...
      if (
        this.type === x.name &&
        (t.push(this.parseImportDefaultSpecifier()), !this.eat(x.comma))
      )
        return t;
      if (this.type === x.star)
    ...
    (e.parseModuleExportName = function () {
      var t;
      return 13 <= this.options.ecmaVersion && this.type === x.string
        ? ((t = this.parseLiteral(this.value)),
          z.test(t.value) &&
            this.raise(
              t.start,
  ...
  var e = C.prototype,
    A =
      ...
      (e.toAssignableList = function (t, e) {
      ...
      (e.parseBindingList = function (t, e, i, s) {
        for (var a = [], r = !0; !this.eat(t); )
          if ((r ? (r = !1) : this.expect(x.comma), e && this.type === x.comma))
            a.push(null);
          else {
      ...
      (e.parseAssignableListItem = function (t) {
        var e = this.parseMaybeDefault(this.start, this.startLoc);
        return this.parseBindingListItem(e), e;
      }),
      (e.parseBindingListItem = function (t) {
        return t;
      }),
      (e.parseMaybeDefault = function (t, e, i) {
        if (
      ...
      (e.checkLValSimple = function (t, e, i) {
      ...
      (e.checkLValPattern = function (t, e, i) {
      ...
      }),
      {
        b_stat: new I(
          "{",
          !(e.checkLValInnerPattern = function (t, e, i) {
            switch ((void 0 === e && (e = 0), t.type)) {
              case "Property":
    ...
    e =
      ...
      (e.braceIsBlock = function (t) {
        var e = this.curContext();
        return (
          e === A.f_expr ||
          e === A.f_stat ||
          (t !== x.colon || (e !== A.b_stat && e !== A.b_expr)
            ? t === x._return || (t === x.name && this.exprAllowed)
              ? l.test(this.input.slice(this.lastTokEnd, this.start))
              : t === x._else ||
                t === x.semi ||
                t === x.eof ||
      ...
      (x.parenL.updateContext = function (t) {
        t = t === x._if || t === x._for || t === x._with || t === x._while;
      ...
      (x._function.updateContext = x._class.updateContext =
        function (t) {
          !t.beforeExpr ||
          t === x._else ||
          (t === x.semi && this.curContext() !== A.p_stat) ||
          (t === x._return &&
            l.test(this.input.slice(this.lastTokEnd, this.start))) ||
          ((t === x.colon || t === x.braceL) && this.curContext() === A.b_stat)
  ...
  (e.checkPropClash = function (t, e, i) {
    ...
    (e.parseExpression = function (t, e) {
      ...
      if (this.type !== x.comma) return a;
      var r = this.startNodeAt(i, s);
      for (r.expressions = [a]; this.eat(x.comma); )
    ...
    (e.parseMaybeAssign = function (t, e, i) {
      ...
      var s = !1,
        ...
        h = this.startLoc,
        p =
          ((this.type !== x.parenL && this.type !== x.name) ||
            ((this.potentialArrowAt = this.start),
            (this.potentialArrowInForAwait = "await" === t)),
          this.parseMaybeConditional(t, e));
      return (
        i && (p = i.call(this, p, o, h)),
        this.type.isAssign
          ? (((i = this.startNodeAt(o, h)).operator = this.value),
            this.type === x.eq && (p = this.toAssignable(p, !1, e)),
    ...
    (e.parseMaybeConditional = function (t, e) {
      ...
      return !this.checkExpressionErrors(e) && this.eat(x.question)
        ? (((e = this.startNodeAt(i, s)).test = a),
    ...
    (e.parseExprOps = function (t, e) {
      var i = this.start,
        s = this.startLoc,
        a = this.parseMaybeUnary(e, !1, !1, t);
    ...
    (e.parseExprOp = function (t, e, i, s, a) {
      var r,
        ...
        p,
        c = this.type.binop;
      if (null != c && (!a || this.type !== x._in) && s < c)
        return (
          (r = this.type === x.logicalOR || this.type === x.logicalAND),
          (n = this.type === x.coalesce) && (c = x.logicalAND.binop),
          (o = this.value),
          this.next(),
          (h = this.start),
          (p = this.startLoc),
          ...
          (p = this.buildBinary(e, i, t, h, o, r || n)),
          ((r && this.type === x.coalesce) ||
            (n && (this.type === x.logicalOR || this.type === x.logicalAND))) &&
            this.raiseRecoverable(
              this.start,
              "Logical expressions and coalesce expressions cannot be mixed. Wrap either by parentheses"
            ),
          this.parseExprOp(p, e, i, s, a)
        );
      return t;
    }),
    (e.buildBinary = function (t, e, i, s, a, r) {
      ...
      return (
        ...
        (t.operator = a),
        (t.right = s),
        this.finishNode(t, r ? "LogicalExpression" : "BinaryExpression")
      );
    }),
    (e.parseMaybeUnary = function (t, e, i, s) {
      var a,
        r = this.start,
        n = this.startLoc;
      if (this.isContextual("await") && this.canAwait)
        ...
        (o.operator = this.value),
          ...
          h
            ...
            : (e = !0),
          (a = this.finishNode(o, h ? "UpdateExpression" : "UnaryExpression"));
      } else if (e || this.type !== x.privateId) {
        if (
          ((a = this.parseExprSubscripts(t, s)), this.checkExpressionErrors(t))
        )
          return a;
    ...
    (e.parseExprSubscripts = function (t, e) {
      var i = this.start,
        s = this.startLoc,
        a = this.parseExprAtom(t, e);
      if (
        "ArrowFunctionExpression" === a.type &&
        ")" !== this.input.slice(this.lastTokStart, this.lastTokEnd)
      )
        return a;
      a = this.parseSubscripts(a, i, s, !1, e);
      return (
        t &&
    ...
    (e.parseSubscripts = function (t, e, i, s, a) {
      for (
        var r =
            8 <= this.options.ecmaVersion &&
            "Identifier" === t.type &&
        ...
        var o,
          h = this.parseSubscript(t, e, i, s, r, n, a);
        if (
          (h.optional && (n = !0),
          h === t || "ArrowFunctionExpression" === h.type)
        )
          return (
            n &&
              (((o = this.startNodeAt(e, i)).expression = h),
              (h = this.finishNode(o, "ChainExpression"))),
            h
          );
        t = h;
      }
    ...
    (e.parseSubscriptAsyncArrow = function (t, e, i, s) {
      return this.parseArrowExpression(this.startNodeAt(t, e), i, !0, s);
    }),
    (e.parseSubscript = function (t, e, i, s, a, r, n) {
      ...
      if (
        p ||
        (h && this.type !== x.parenL && this.type !== x.backQuote) ||
        this.eat(x.dot)
      ) {
        var c = this.startNodeAt(e, i);
        (c.object = t),
          p
            ? ((c.property = this.parseExpression()), this.expect(x.bracketR))
            : this.type === x.privateId && "Super" !== t.type
        ...
        var p = new S(),
          ...
          u =
            ...
            (this.awaitPos = 0),
            (this.awaitIdentPos = 0),
            this.parseExprList(x.parenR, 8 <= this.options.ecmaVersion, !1, p));
        if (a && !h && this.shouldParseAsyncArrow())
          return (
    ...
    (e.parseExprAtom = function (t, e, i) {
      ...
      switch (this.type) {
        ...
        case x.name:
          ...
          if (
            ...
            return (
              ...
              this.parseFunction(this.startNodeAt(a, r), 0, !1, !0, e)
            );
          if (s && !this.canInsertSemicolon()) {
            if (this.eat(x.arrow))
              return this.parseArrowExpression(
                this.startNodeAt(a, r),
                [o],
                !1,
                e
              );
            if (
              ...
              return (
                (o = this.parseIdent(!1)),
                (!this.canInsertSemicolon() && this.eat(x.arrow)) ||
                  this.unexpected(),
                this.parseArrowExpression(this.startNodeAt(a, r), [o], !0, e)
              );
          }
          return o;
        case x.regexp:
          var h,
            n = this.value;
          return (
            ((h = this.parseLiteral(n.value)).regex = {
              pattern: n.pattern,
              flags: n.flags,
            }),
            h
        ...
        case x._false:
          return (
            ((h = this.startNode()).value =
              this.type === x._null ? null : this.type === x._true),
            (h.raw = this.type.keyword),
            this.next(),
            this.finishNode(h, "Literal")
          );
        case x.parenL:
          (a = this.start), (r = this.parseParenAndDistinguishExpression(s, e));
          return (
            t &&
              (t.parenthesizedAssign < 0 &&
                !this.isSimpleAssignTarget(r) &&
                (t.parenthesizedAssign = a),
              t.parenthesizedBind < 0 && (t.parenthesizedBind = a)),
            r
          );
        case x.bracketL:
          return (
            (h = this.startNode()),
            this.next(),
            (h.elements = this.parseExprList(x.bracketR, !0, !0, t)),
            this.finishNode(h, "ArrayExpression")
          );
        case x.braceL:
          return this.overrideContext(A.b_expr), this.parseObj(!1, t);
        case x._function:
    ...
    (e.parseExprImport = function (t) {
      ...
      return (
        ...
        this.next(),
        this.type !== x.parenL || t
          ? this.type === x.dot
            ? (((t = this.startNodeAt(e.start, e.loc && e.loc.start)).name =
                "import"),
              (e.meta = this.finishNode(t, "Identifier")),
              this.parseImportMeta(e))
            : void this.unexpected()
          : this.parseDynamicImport(e)
      );
    }),
    (e.parseDynamicImport = function (t) {
      ...
      return (
        ...
        this.eat(x.parenR) ||
          ((e = this.start),
          this.eat(x.comma) && this.eat(x.parenR)
            ? this.raiseRecoverable(
                e,
    ...
    (e.parseParenAndDistinguishExpression = function (t, e) {
      ...
      if (6 <= this.options.ecmaVersion) {
        ...
        for (this.yieldPos = 0, this.awaitPos = 0; this.type !== x.parenR; ) {
          if (
            (c ? (c = !1) : this.expect(x.comma),
            r && this.afterTrailingComma(x.parenR, !0))
          ) {
            l = !0;
            break;
          }
        ...
        if (
          (this.expect(x.parenR),
          t && this.shouldParseArrow(p) && this.eat(x.arrow))
        )
          return (
            ...
            (this.yieldPos = d),
            (this.awaitPos = f),
            this.parseParenArrowList(s, a, p, e)
          );
      ...
      return this.options.preserveParens
        ? (((t = this.startNodeAt(s, a)).expression = i),
    ...
    (e.parseParenArrowList = function (t, e, i, s) {
  ...
  function P(t, e, i) {
    (this.type = ""),
      (this.start = e),
      (this.end = 0),
      t.options.locations && (this.loc = new _(t, i)),
  ...
  var at = [],
    e =
      ((e.parseNew = function () {
        ...
        var t = this.startNode();
        if ((this.next(), 6 <= this.options.ecmaVersion && this.type === x.dot))
          return (
      ...
      (e.parseTemplateElement = function (t) {
        ...
        return (
          ...
          this.next(),
          (e.tail = this.type === x.backQuote),
          this.finishNode(e, "TemplateElement")
        );
      }),
      (e.parseTemplate = function (t) {
        var e = (t = void 0 === t ? {} : t).isTagged,
          i = (void 0 === e && (e = !1), this.startNode()),
          s =
            (this.next(),
            (i.expressions = []),
            this.parseTemplateElement({ isTagged: e }));
      ...
      (e.isAsyncProp = function (t) {
        return (
          ...
          (this.type === x.name ||
            ...
            this.type === x.bracketL ||
            this.type.keyword ||
            (9 <= this.options.ecmaVersion && this.type === x.star)) &&
          !l.test(this.input.slice(this.lastTokEnd, this.start))
        );
      }),
      (e.parseObj = function (t, e) {
        ...
        for (i.properties = [], this.next(); !this.eat(x.braceR); ) {
          if (s) s = !1;
            ...
            (this.expect(x.comma),
            5 <= this.options.ecmaVersion && this.afterTrailingComma(x.braceR))
          )
            break;
      ...
      (e.parseProperty = function (t, e) {
        var i,
          ...
          r,
          n = this.startNode();
        if (9 <= this.options.ecmaVersion && this.eat(x.ellipsis))
          return t
        ...
        return (
          ...
          !t && !o && 8 <= this.options.ecmaVersion && !i && this.isAsyncProp(n)
            ? ((s = !0),
              (i = 9 <= this.options.ecmaVersion && this.eat(x.star)),
              this.parsePropertyName(n))
            : (s = !1),
      ...
      (e.parsePropertyValue = function (t, e, i, s, a, r, n, o) {
        (i || s) && this.type === x.colon && this.unexpected(),
          this.eat(x.colon)
            ? ((t.value = e
                ? this.parseMaybeDefault(this.start, this.startLoc)
                : this.parseMaybeAssign(!1, n)),
              (t.kind = "init"))
            : 6 <= this.options.ecmaVersion && this.type === x.parenL
            ? (e && this.unexpected(),
              (t.kind = "init"),
              (t.method = !0),
      ...
      (e.parsePropertyName = function (t) {
        ...
        return (t.key =
          this.type === x.num || this.type === x.string
            ? this.parseExprAtom()
      ...
      (e.parseMethod = function (t, e, i) {
        ...
        return (
          ...
          (this.awaitPos = 0),
          (this.awaitIdentPos = 0),
          this.enterScope(64 | Z(e, s.generator) | (i ? 128 : 0)),
          this.expect(x.parenL),
      ...
      (e.parseArrowExpression = function (t, e, i, s) {
        var a = this.yieldPos,
          r = this.awaitPos,
          n = this.awaitIdentPos;
        return (
          this.enterScope(16 | Z(i, !1)),
          this.initFunction(t),
      ...
      (e.parseFunctionBody = function (t, e, i, s) {
        var a = e && this.type !== x.braceL,
          r = this.strict,
          n = !1;
        a
      ...
      (e.parseExprList = function (t, e, i, s) {
        for (var a = [], r = !0; !this.eat(t); ) {
          if (r) r = !1;
          else if ((this.expect(x.comma), e && this.afterTrailingComma(t)))
            break;
          var n = void 0;
          i && this.type === x.comma
            ? (n = null)
      ...
      (e.checkUnreserved = function (t) {
        ...
        this.inGenerator &&
          ...
          !this.inClassStaticBlock ||
            ...
            this.raise(
              e,
              "Cannot use " + t + " in class static initialization block"
            ),
      ...
      (e.parsePrivateIdent = function () {
        var t = this.startNode();
        return (
          this.type === x.privateId ? (t.name = this.value) : this.unexpected(),
          this.next(),
      ...
      (e.parseYield = function (t) {
        ...
        return (
          ...
          this.type === x.semi ||
          this.canInsertSemicolon() ||
          (this.type !== x.star && !this.type.startsExpr)
      ...
      C.prototype),
    e =
      ((e.raise = function (t, e) {
        var i = b(this.input, t),
          e = ((e += " (" + i.line + ":" + i.column + ")"), new SyntaxError(e));
      ...
      C.prototype),
    e =
      ((e.enterScope = function (t) {
        this.scopeStack.push(new st(t));
      }),
      (e.exitScope = function () {
        this.scopeStack.pop();
      }),
      (e.treatFunctionsAsVarInScope = function (t) {
      ...
      (e.declareName = function (t, e, i) {
        ...
        if (2 === e) {
          ...
          (s = this.treatFunctionsAsVar
            ? -1 < a.lexical.indexOf(t)
            : -1 < a.lexical.indexOf(t) || -1 < a.var.indexOf(t)),
            a.functions.push(t);
        } else
          for (var r = this.scopeStack.length - 1; 0 <= r; --r) {
            ...
            if (
              ...
              (!this.treatFunctionsAsVarInScope(n) &&
  ...
  (e.startNode = function () {
    return new P(this, this.start, this.startLoc);
  }),
    (e.startNodeAt = function (t, e) {
      return new P(this, t, e);
    }),
    (e.finishNode = function (t, e) {
      return rt.call(this, t, e, this.lastTokEnd, this.lastTokEndLoc);
    }),
    (e.finishNodeAt = function (t, e, i, s) {
      return rt.call(this, t, e, i, s);
    }),
    (e.copyNode = function (t) {
      var e,
        i = new P(this, t.start, this.startLoc);
      for (e in t) i[e] = t[e];
      return i;
    });
  var e =
    ...
    T = e + " Extended_Pictographic",
    N = T + " EBase EComp EMod EPres ExtPict",
    nt = {
      9: e,
      10: T,
      11: T,
    ...
    ct =
      pt + " Cypro_Minoan Cpmn Old_Uyghur Ougr Tangsa Tnsa Toto Vithkuqi Vith",
    lt = {
      9: e,
      10: T,
      11: N,
    ...
    ut = {};
  for (var V, dt = 0, ft = [9, 10, 11, 12, 13, 14]; dt < ft.length; dt += 1)
    ((V = ut[(V = ft[dt])] =
      {
        binary: g(nt[V] + " " + ht),
        binaryOfStrings: g(ot[V]),
        nonBinary: { General_Category: g(ht), Script: g(lt[V]) },
      }).nonBinary.Script_Extensions = V.nonBinary.Script),
      (V.nonBinary.gc = V.nonBinary.General_Category),
      (V.nonBinary.sc = V.nonBinary.Script),
      (V.nonBinary.scx = V.nonBinary.Script_Extensions);
  function L(t) {
    (this.parser = t),
      (this.validFlags =
        "gim" +
        ...
        (13 <= t.options.ecmaVersion ? "d" : "") +
        (15 <= t.options.ecmaVersion ? "v" : "")),
      (this.unicodeProperties =
        ut[14 <= t.options.ecmaVersion ? 14 : t.options.ecmaVersion]),
      (this.source = ""),
      (this.flags = ""),
      (this.start = 0),
      (this.switchU = !1),
  ...
  (L.prototype.reset = function (t, e, i) {
    var s = -1 !== i.indexOf("v"),
      a = -1 !== i.indexOf("u");
    (this.start = 0 | t),
      (this.source = e + ""),
      (this.flags = i),
      s && 15 <= this.parser.options.ecmaVersion
        ? ((this.switchU = !0), (this.switchV = !0), (this.switchN = !0))
        : ((this.switchU = a && 6 <= this.parser.options.ecmaVersion),
          (this.switchV = !1),
    ...
    (L.prototype.at = function (t, e) {
      ...
      if ((!e && !this.switchU) || a <= 55295 || 57344 <= a || s <= t + 1)
        return a;
      e = i.charCodeAt(t + 1);
      return 56320 <= e && e <= 57343 ? (a << 10) + e - 56613888 : a;
    }),
    (L.prototype.nextIndex = function (t, e) {
      void 0 === e && (e = !1);
      var i = this.source,
        s = i.length;
      if (s <= t) return s;
    ...
    (L.prototype.eat = function (t, e) {
      return (
        this.current((e = void 0 === e ? !1 : e)) === t && (this.advance(e), !0)
      );
    }),
    (L.prototype.eatChars = function (t, e) {
      void 0 === e && (e = !1);
    ...
    (e.validateRegExpFlags = function (t) {
      for (
        var e = t.validFlags, i = t.flags, s = !1, a = !1, r = 0;
        r < i.length;
        r++
      ) {
        var n = i.charAt(r);
    ...
    (e.validateRegExpPattern = function (t) {
    ...
    (e.regexp_disjunction = function (t) {
    ...
    (e.regexp_alternative = function (t) {
      for (; t.pos < t.source.length && this.regexp_eatTerm(t); );
    }),
    (e.regexp_eatTerm = function (t) {
    ...
    (e.regexp_eatAssertion = function (t) {
      var e = t.pos;
    ...
    (e.regexp_eatQuantifier = function (t, e) {
      return (
        !!this.regexp_eatQuantifierPrefix(t, (e = void 0 === e ? !1 : e)) &&
        (t.eat(63), !0)
      );
    }),
    (e.regexp_eatQuantifierPrefix = function (t, e) {
      return (
        t.eat(42) ||
        t.eat(43) ||
        t.eat(63) ||
    ...
    (e.regexp_eatBracedQuantifier = function (t, e) {
      var i = t.pos;
      if (t.eat(123)) {
        var s,
          a = -1;
    ...
    (e.regexp_eatReverseSolidusAtomEscape = function (t) {
      var e = t.pos;
      if (t.eat(92)) {
    ...
    (e.regexp_eatUncapturingGroup = function (t) {
      var e = t.pos;
      if (t.eat(40)) {
    ...
    (e.regexp_eatCapturingGroup = function (t) {
      if (t.eat(40)) {
        if (
          (9 <= this.options.ecmaVersion
    ...
    (e.regexp_eatExtendedAtom = function (t) {
      return (
        t.eat(46) ||
        this.regexp_eatReverseSolidusAtomEscape(t) ||
        this.regexp_eatCharacterClass(t) ||
    ...
    (e.regexp_eatInvalidBracedQuantifier = function (t) {
      return (
        this.regexp_eatBracedQuantifier(t, !0) && t.raise("Nothing to repeat"),
        !1
      );
    }),
    (e.regexp_eatSyntaxCharacter = function (t) {
      var e = t.current();
      return !!mt(e) && ((t.lastIntValue = e), t.advance(), !0);
    }),
    (e.regexp_eatPatternCharacters = function (t) {
      for (var e, i = t.pos; -1 !== (e = t.current()) && !mt(e); ) t.advance();
      return t.pos !== i;
    }),
    (e.regexp_eatExtendedPatternCharacter = function (t) {
      var e = t.current();
      return (
        !(
          -1 === e ||
    ...
    (e.regexp_groupSpecifier = function (t) {
      if (t.eat(63)) {
    ...
    (e.regexp_eatGroupName = function (t) {
    ...
    (e.regexp_eatRegExpIdentifierName = function (t) {
      if (((t.lastStringValue = ""), this.regexp_eatRegExpIdentifierStart(t))) {
        for (
          t.lastStringValue += y(t.lastIntValue);
    ...
    (e.regexp_eatRegExpIdentifierStart = function (t) {
      var e = t.pos,
    ...
    (e.regexp_eatRegExpIdentifierPart = function (t) {
      var e = t.pos,
        i = 11 <= this.options.ecmaVersion,
        s = t.current(i);
      return (
        ...
        92 === s &&
          this.regexp_eatRegExpUnicodeEscapeSequence(t, i) &&
          (s = t.lastIntValue),
        o((i = s), !0) || 36 === i || 95 === i || 8204 === i || 8205 === i
          ? ((t.lastIntValue = s), !0)
          : ((t.pos = e), !1)
      );
    }),
    (e.regexp_eatAtomEscape = function (t) {
      return (
        !!(
    ...
    (e.regexp_eatBackReference = function (t) {
      var e = t.pos;
    ...
    (e.regexp_eatKGroupName = function (t) {
      if (t.eat(107)) {
        if (this.regexp_eatGroupName(t))
    ...
    (e.regexp_eatCharacterEscape = function (t) {
      return (
    ...
    (e.regexp_eatCControlLetter = function (t) {
      var e = t.pos;
      if (t.eat(99)) {
    ...
    (e.regexp_eatControlEscape = function (t) {
      var e = t.current();
      return 116 === e
    ...
    (e.regexp_eatControlLetter = function (t) {
      var e = t.current();
      return !!gt(e) && ((t.lastIntValue = e % 32), t.advance(), !0);
    }),
    (e.regexp_eatRegExpUnicodeEscapeSequence = function (t, e) {
      var i = t.pos,
        e = (e = void 0 === e ? !1 : e) || t.switchU;
      if (t.eat(117)) {
        if (this.regexp_eatFixedHexDigits(t, 4)) {
          ...
          if (e && 55296 <= s && s <= 56319) {
            ...
            if (
              ...
              if (56320 <= r && r <= 57343)
                return (
                  (t.lastIntValue = 1024 * (s - 55296) + (r - 56320) + 65536),
                  !0
                );
            }
        ...
        if (
          ...
          return !0;
        e && t.raise("Invalid unicode escape"), (t.pos = i);
      }
      return !1;
    }),
    (e.regexp_eatIdentityEscape = function (t) {
      if (t.switchU)
        return (
    ...
    (e.regexp_eatDecimalEscape = function (t) {
      t.lastIntValue = 0;
      var e = t.current();
      if (49 <= e && e <= 57) {
        for (
  ...
  (e.regexp_eatCharacterClassEscape = function (t) {
    var e = t.current();
    if (
      100 === (s = e) ||
      68 === s ||
    ...
    if (
      ...
      if (
        ...
        t.advance(),
        t.eat(123) &&
          (i = this.regexp_eatUnicodePropertyValueExpression(t)) &&
          t.eat(125))
      )
        return s && 2 === i && t.raise("Invalid property name"), i;
      t.raise("Invalid property name");
    }
    return 0;
  }),
    (e.regexp_eatUnicodePropertyValueExpression = function (t) {
      var e = t.pos;
    ...
    (e.regexp_validateUnicodePropertyNameAndValue = function (t, e, i) {
      m(t.unicodeProperties.nonBinary, e) || t.raise("Invalid property name"),
        t.unicodeProperties.nonBinary[e].test(i) ||
          t.raise("Invalid property value");
    }),
    (e.regexp_validateUnicodePropertyNameOrValue = function (t, e) {
    ...
    (e.regexp_eatUnicodePropertyName = function (t) {
      var e;
      for (t.lastStringValue = ""; xt((e = t.current())); )
        (t.lastStringValue += y(e)), t.advance();
      return "" !== t.lastStringValue;
    }),
    (e.regexp_eatUnicodePropertyValue = function (t) {
      var e, i;
      for (t.lastStringValue = ""; xt((i = e = t.current())) || R(i); )
        (t.lastStringValue += y(e)), t.advance();
      return "" !== t.lastStringValue;
    }),
    (e.regexp_eatLoneUnicodePropertyNameOrValue = function (t) {
      return this.regexp_eatUnicodePropertyValue(t);
    }),
    (e.regexp_eatCharacterClass = function (t) {
      var e, i;
      return (
        !!t.eat(91) &&
        ((e = t.eat(94)),
        ...
        e && 2 === i && t.raise("Negated character class may contain strings"),
        !0)
      );
    }),
    (e.regexp_classContents = function (t) {
      return 93 === t.current()
        ? 1
        : t.switchV
    ...
    (e.regexp_nonEmptyClassRanges = function (t) {
    ...
    (e.regexp_eatClassAtom = function (t) {
      var e = t.pos;
      if (t.eat(92)) {
    ...
    (e.regexp_eatClassEscape = function (t) {
      var e = t.pos;
    ...
    (e.regexp_classSetExpression = function (t) {
      var e,
        i = 1;
      if (!this.regexp_eatClassSetRange(t))
        if ((e = this.regexp_eatClassSetOperand(t))) {
          2 === e && (i = 2);
    ...
    (e.regexp_eatClassSetRange = function (t) {
      var e = t.pos;
    ...
    (e.regexp_eatNestedClass = function (t) {
      ...
      if (t.eat(92)) {
        i = this.regexp_eatCharacterClassEscape(t);
        if (i) return i;
        t.pos = e;
      }
      return null;
    }),
    (e.regexp_eatClassStringDisjunction = function (t) {
      var e = t.pos;
    ...
    (e.regexp_eatClassSetCharacter = function (t) {
      ...
      return (
        ...
        (t.advance(), (t.lastIntValue = e), !0)
      );
    }),
    (e.regexp_eatClassSetReservedPunctuator = function (t) {
      var e,
        i = t.current();
      return (
        (33 === (e = i) ||
          ...
          96 === e ||
          126 === e) &&
        ((t.lastIntValue = i), t.advance(), !0)
      );
    }),
    (e.regexp_eatClassControlLetter = function (t) {
      var e = t.current();
      return (
        !(!R(e) && 95 !== e) && ((t.lastIntValue = e % 32), t.advance(), !0)
      );
    }),
    (e.regexp_eatHexEscapeSequence = function (t) {
      var e = t.pos;
      if (t.eat(120)) {
    ...
    (e.regexp_eatDecimalDigits = function (t) {
      var e,
        i = t.pos;
      for (t.lastIntValue = 0; R((e = t.current())); )
        (t.lastIntValue = 10 * t.lastIntValue + (e - 48)), t.advance();
      return t.pos !== i;
    }),
    (e.regexp_eatHexDigits = function (t) {
      var e,
        i = t.pos;
      for (t.lastIntValue = 0; yt((e = t.current())); )
        (t.lastIntValue = 16 * t.lastIntValue + vt(e)), t.advance();
      return t.pos !== i;
    }),
    (e.regexp_eatLegacyOctalEscapeSequence = function (t) {
      var e, i;
      return (
    ...
    (e.regexp_eatOctalDigit = function (t) {
      var e = t.current();
      return _t(e)
        ? ((t.lastIntValue = e - 48), t.advance(), !0)
        : ((t.lastIntValue = 0), !1);
    }),
    (e.regexp_eatFixedHexDigits = function (t, e) {
      for (var i = t.pos, s = (t.lastIntValue = 0); s < e; ++s) {
        var a = t.current();
        if (!yt(a)) return (t.pos = i), !1;
        (t.lastIntValue = 16 * t.lastIntValue + vt(a)), t.advance();
      }
      return !0;
    });
  function D(t) {
    (this.type = t.type),
      ...
      (this.start = t.start),
      (this.end = t.end),
      t.options.locations && (this.loc = new _(t, t.startLoc, t.endLoc)),
  ...
  (T.next = function (t) {
    !t &&
      ...
      this.options.onToken && this.options.onToken(new D(this)),
    ...
    (T.readToken = function (t) {
      return n(t, 6 <= this.options.ecmaVersion) || 92 === t
        ? this.readWord()
    ...
    (T.skipBlockComment = function () {
      ...
      if (
        ...
        for (var s, a = e; -1 < (s = H(this.input, a, this.pos)); )
        ...
        switch (t) {
          ...
          default:
            if (
              !(
                (8 < t && t < 14) ||
                (5760 <= t && d.test(String.fromCharCode(t)))
              )
            )
              break t;
            ++this.pos;
    ...
    (T.readToken_mult_modulo_exp = function (t) {
      ...
      return (
        7 <= this.options.ecmaVersion &&
          42 === t &&
          42 === e &&
          (++i, (s = x.starstar), (e = this.input.charCodeAt(this.pos + 2))),
        61 === e ? this.finishOp(x.assign, i + 1) : this.finishOp(s, i)
      );
    }),
    (T.readToken_pipe_amp = function (t) {
      ...
      if (e !== t)
        return 61 === e
          ? this.finishOp(x.assign, 2)
          : this.finishOp(124 === t ? x.bitwiseOR : x.bitwiseAND, 1);
      if (
      ...
      return e === t
        ? ((i = 62 === t && 62 === this.input.charCodeAt(this.pos + 2) ? 3 : 2),
          61 === this.input.charCodeAt(this.pos + i)
            ? this.finishOp(x.assign, i + 1)
            : this.finishOp(x.bitShift, i))
        : 33 !== e ||
          60 !== t ||
          this.inModule ||
          45 !== this.input.charCodeAt(this.pos + 2) ||
          45 !== this.input.charCodeAt(this.pos + 3)
        ? this.finishOp(x.relational, (i = 61 === e ? 2 : i))
    ...
    (T.readToken_eq_excl = function (t) {
      ...
      return 61 === e
        ...
        : this.finishOp(61 === t ? x.eq : x.prefix, 1);
    }),
    (T.readToken_question = function () {
      ...
      if (11 <= t) {
        ...
        if (46 === e) {
          ...
          if (i < 48 || 57 < i) return this.finishOp(x.questionDot, 2);
        }
        if (63 === e) {
          if (12 <= t)
    ...
    (T.readToken_numberSign = function () {
      ...
      if (
        13 <= t &&
        (++this.pos, n((e = this.fullCharCodeAtPos()), !0) || 92 === e)
      )
    ...
    (T.readRegexp = function () {
      for (var t, e, i = this.pos; ; ) {
        ...
        if ((l.test(s) && this.raise(i, "Unterminated regular expression"), t))
          t = !1;
        else {
          if ("[" === s) e = !0;
          else if ("]" === s && e) e = !1;
      ...
      var a = this.input.slice(i, this.pos),
        ...
        r =
          ...
          this.regexpState || (this.regexpState = new L(this))),
        r =
          (r.reset(i, a, n),
      ...
      return this.finishToken(x.regexp, { pattern: a, flags: n, value: r });
    }),
    (T.readInt = function (t, e, i) {
      for (
    ...
    (T.readNumber = function (t) {
      ...
      if (!i && !t && 11 <= this.options.ecmaVersion && 110 === s)
        return (
          (t = bt(this.input.slice(e, this.pos))),
          ++this.pos,
          n(this.fullCharCodeAtPos()) &&
            this.raise(this.pos, "Identifier directly after number"),
      ...
      s = i ? parseInt(t, 8) : parseFloat(t.replace(/_/g, ""));
    ...
    (T.readString = function (t) {
      for (var e = "", i = ++this.pos; ; ) {
        ...
        92 === s
          ? ((e =
              (e += this.input.slice(i, this.pos)) + this.readEscapedChar(!1)),
            (i = this.pos))
          : 8232 === s || 8233 === s
      ...
      return (
        (e += this.input.slice(i, this.pos++)), this.finishToken(x.string, e)
      );
    });
  var kt = {};
  (T.tryReadTemplateToken = function () {
    ...
    (T.invalidStringToken = function (t, e) {
      if (this.inTemplateElement && 9 <= this.options.ecmaVersion) throw kt;
      this.raise(t, e);
    }),
      ...
      for (var t = "", e = this.pos; ; ) {
        ...
        if (
          ...
          return this.pos !== this.start ||
            (this.type !== x.template && this.type !== x.invalidTemplate)
            ? ((t += this.input.slice(e, this.pos)),
              this.finishToken(x.template, t))
            : 36 === i
            ? ((this.pos += 2), this.finishToken(x.dollarBraceL))
            : (++this.pos, this.finishToken(x.backQuote));
        if (92 === i)
          (t = (t += this.input.slice(e, this.pos)) + this.readEscapedChar(!0)),
            (e = this.pos);
        else if (u(i)) {
    ...
    (T.readEscapedChar = function (t) {
      ...
      switch ((++this.pos, s)) {
        ...
        default:
          return 48 <= s && s <= 55
            ? ((e = this.input.substr(this.pos - 1, 3).match(/^[0-7]+/)[0]),
              255 < (i = parseInt(e, 8)) &&
  ...
  (C.acorn = {
    ...
    (t.defaultOptions = k),
    (t.getLineInfo = b),
    (t.isIdentifierChar = o),
    (t.isIdentifierStart = n),
    (t.isNewLine = u),
    (t.keywordTypes = p),
    (t.lineBreak = l),
    (t.lineBreakG = i),
    (t.nonASCIIwhitespace = d),
    (t.parse = function (t, e) {
      return C.parse(t, e);
    }),
    (t.parseExpressionAt = function (t, e, i) {
      return C.parseExpressionAt(t, e, i);
    }),
    (t.tokContexts = A),
    (t.tokTypes = x),
    (t.tokenizer = function (t, e) {
      return C.tokenizer(t, e);
    }),
    (t.version = "8.11.3");
});
